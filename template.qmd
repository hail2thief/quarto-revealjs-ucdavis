...
The Quarto reveal.js UC Davis theme uses Atkinson Hyperlegible Next and UC Davis brand colors
(Aggie Blue `#022851` and Aggie Gold `#B3A369`) on an off-white background.
